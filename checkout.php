...
$user = $_POST['username'];
$pass = $_POST['password'];
$register_query = "INSERT INTO `register4`(`fname`, `mname`, `lname`, `address`, `phone`, `email`, `username`, `password`) VALUES ('$fname','$mname','$lname','$address','$phone','$email','$user','$pass')";
try{
                    ...
                    <ul class="dropdown">
                      ...
                      <li class="has-children">
                        ...
                        <ul class="dropdown">
                          ...
                          <li><a href="#">Sector-4 & Sector 3</a></li>
                          <li><a href="#">Sector-5 & sector-6</a></li>
                          <li><a href="#">Sector-8</a></li>
                          <li><a href="#">Sector-9</a></li>
                      ...
                      <li class="has-children">
                        ...
                        <ul class="dropdown">
                          ...
                          <li><a href="#">sealdah</a></li>
                          <li><a href="#">tollygunj</a></li>
                      ...
                      <li class="has-children">
                        ...
                        <ul class="dropdown">
                          ...
                          <li><a href="#">juhu</a></li>
                          <li><a href="#">malad</a></li>
                          <li><a href="#">vasai</a></li>
                          <li><a href="#">Kandavali</a></li>
                      ...
                      <li class="has-children">
                        ...
                        <ul class="dropdown">
                          ...
                          <li><a href="#">Chandani chowk & old delhi</a></li>
                          <li><a href="#">Greater kailash 1</a></li>
